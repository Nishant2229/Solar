...
import styles from "./CitizenEmailVerification.module.css";
...
const CitizenEmailVerification = () => {
  ...
  useEffect(() => {
    if (citizenFormData.email) {
      setEmail(citizenFormData.email);
    }
  }, [citizenFormData.email]);

  console.log(`Check The Otp Sent to => ${email}`);
...
export default CitizenEmailVerification;
