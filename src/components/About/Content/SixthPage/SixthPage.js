...
const SixthPage = () => {
  return (
    <div className="max-w-[1440px] min-w-[1200px] container -mt-32 flex">
      ...
      <div
        className="container ml-[350px] xl2:ml-[420px] md:max-w-[830px] xl2:max-w-[1000px]
                     s:max-w-[820px]"
      >
        <div className="content">
          <p className="font-semibold text-3xl pt-5 pl-4 max-w-[600px]">
            Steps to Get Started with Solar Energy
          </p>
          ...
          <div className="pl-4 pt-5">
            <p>
              ...
              towards a greener and more sustainable future. Switching to solar
              power not only helps lower your environmental impact but also
              provides long-term financial advantages. To help you begin your
              solar journey, here are some key steps to follow.
            </p>
          </div>

          <div className="pl-4 pt-8">
            <p className="font-semibold">Assess Your Energy Usage:</p>
            <p>
              Start by understanding how much energy you currently consume.
              Review your electricity bills to determine your usage and identify
              peak periods. This analysis will help you determine the size of
              the solar energy system you need.
            </p>
          </div>

          <div className="pl-4 pt-8">
            <p className="font-semibold">Research and Seek Advice:</p>
            <p>
              Educate yourself about solar energy and its different aspects.
              Explore various solar technologies, incentives, and financing
              options. Consult reliable solar companies for expert guidance and
              obtain multiple quotes to compare.
            </p>
          </div>

          <div className="pl-4 pt-8">
            <p className="font-semibold">Site Evaluation:</p>
            <p>
          ...
          <div className="pl-4 pt-8">
            ...
            <p className="pb-10">
              Understand local regulations and acquire the necessary permits for
              solar panel installation. Your installer should assist you in this
              process, ensuring compliance with building codes and utility
              requirements
            </p>
          </div>
        </div>
